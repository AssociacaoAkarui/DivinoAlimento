...
const PedidoConsumidores = () => {
  ...
  const productGroups = useMemo(() => {
    ...
    return groups
      .map((group) => ({
        ...group,
        variantes: group.variantes.filter(
          (v) =>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              disabled={
                                item.quantidade >= item.quantidadeOfertada
                              }
                              className="h-8 w-8 p-0"
                            >
                  ...
                  group.variantes.map((produto) => {
                    ...
                    return (
                      <div
                        key={produto.id}
                        onClick={() =>
                          !isEsgotado && handleToggleProduct(produto.id)
                        }
                        className={`
                      ...
                      >
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-foreground">
                              {produto.quantidadeOfertada} unidades
                            </span>
                          </div>
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                >
                                  ...
                                  <Button
                                    ...
                                    disabled={
                                      quantidade >= produto.quantidadeOfertada
                                    }
                                    className="h-8 w-8 p-0"
                                  >
                                    <Plus className="w-4 h-4" />
                          ...
                          >
                            <TableCell>
                              <Checkbox
                                checked={isSelected}
                                onCheckedChange={() =>
                                  handleToggleProduct(produto.id)
                                }
                                disabled={isEsgotado}
                              />
                            </TableCell>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg flex gap-3">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  Deseja confirmar o pedido? Após confirmação, ele será enviado
                  ao sistema de vendas.
                </p>
              </div>
            </div>
