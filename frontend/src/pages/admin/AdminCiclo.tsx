...
const AdminCiclo = () => {
          ...
          if (field === "ordem_atendimento") {
            ...
            const reordenados = outrosMercados.map((item) => {
              if (ordemAntiga < novaOrdem) {
                ...
                if (
                  item.ordem_atendimento > ordemAntiga &&
                  item.ordem_atendimento <= novaOrdem
                ) {
                  return {
                    ...item,
                    ordem_atendimento: item.ordem_atendimento - 1,
                  };
                }
              } else {
            ...
            const mercadoAtualizado = {
              ...mercadoAtual,
              ordem_atendimento: novaOrdem,
            };

            // Combinar e reordenar
            const todosReordenados = [...reordenados, mercadoAtualizado].sort(
              (a, b) => a.ordem_atendimento - b.ordem_atendimento,
            );
  ...
  const handleSubmit = () => {
    ...
    // Simular save
    toast.success(
      isEdit ? "Ciclo atualizado com sucesso!" : "Ciclo criado com sucesso!",
    );
    ...
    >
      <div className="space-y-6 pb-20">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            {isEdit && administradorResponsavel && (
              <p className="text-sm text-muted-foreground mt-1">
                Responsável:{" "}
                {
                  administradoresDisponiveis.find(
                    (a) => a.id === administradorResponsavel,
                  )?.nome
                }
              </p>
            )}
          ...
          {isEdit && (
            <Badge
              className={status === "ativo" ? "bg-green-500" : "bg-orange-500"}
            >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {mercado.mercado_id && (
                              <Badge variant="secondary" className="text-xs">
                                Admin:{" "}
                                {getAdministradorMercado(mercado.mercado_id)}
                              </Badge>
                            )}
                          </div>
                          <Button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Select
                              ...
                              disabled={
                                mercado.mercado_id &&
                                getTiposVendaPermitidos(mercado.mercado_id)
                                  .length === 1
                              }
                            >
                              <SelectTrigger>
                          ...
                          <Label className="flex items-center gap-2">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  Define a prioridade dos mercados (1 é atendido
                                  primeiro)
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
