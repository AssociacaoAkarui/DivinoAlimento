        ...
        if (order.id === orderId && order.canMarkReceived) {
          ...
          toast({
            title: received
              ...
              : "Pedido marcado como não recebido",
              ...
              <Card className="text-center bg-destructive/10">
                <CardContent className="p-4">
                  <div className="text-2xl font-bold text-destructive">
                    {
                      filteredOrders.filter((o) => o.status === "not-received")
                        .length
                    }
                  </div>
                      ...
                      return (
                        <div key={order.id}>
                          ...
                          <div className="lg:hidden">
                            <Card
                              className={`m-4 ${statusConfig.bgColor} ${statusConfig.borderColor} border-2`}
                            >
                              <CardContent className="p-4">
