...
export const ConsumerProvider: React.FC<ConsumerProviderProps> = ({
  children,
}) => {
  ...
  const [consumerType, setConsumerType] = useState<ConsumerType>(() => {
    ...
    console.warn("ConsumerContext: Loading stored type:", storedType);
  ...
  return (
    <ConsumerContext.Provider
      value={{ consumerType, setConsumerType: handleSetConsumerType }}
    >
      {children}
    </ConsumerContext.Provider>
  );
