...
interface AddProductModalProps {
  ...
  onClose: () => void;
  onSaveDraft: (
    product: Omit<ProductInCycle, "id" | "lastUpdated" | "updatedBy">,
  ) => void;
  onApprove: (
    product: Omit<ProductInCycle, "id" | "lastUpdated" | "updatedBy">,
  ) => void;
  ...
  const filteredProducts = useMemo(() => {
    return produtosReferencia.filter((produto) => {
      ...
      const matchesCategory =
        categoryFilter === "all" || produto.categoria === categoryFilter;
                ...
                <TableBody>
                  {filteredProducts.map((produto) => (
                    <TableRow key={produto.id}>
                      ...
                      <TableCell>
                        R$ {produto.preco_referencia.toFixed(2)}
                      </TableCell>
                      <TableCell>
                        <Button
                          size="sm"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.mercadoPrioritario}
                  onValueChange={(value) =>
                    handleInputChange("mercadoPrioritario", value)
                  }
                >
                  <SelectTrigger>
