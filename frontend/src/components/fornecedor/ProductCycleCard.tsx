...
const ProductCycleCard: React.FC<ProductCycleCardProps> = ({
  ...
  const isValid =
    localProduct.pricePerUnit &&
    localProduct.pricePerUnit > 0 &&
    ...
    >
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              {localProduct.metadados?.mercado_prioritario_nome && (
                <Badge
                  variant="outline"
                  className="text-xs text-blue-700 bg-blue-50"
                >
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {localProduct.expiryDate ? (
                    format(localProduct.expiryDate, "dd/MM/yyyy", {
                      locale: ptBR,
                    })
                  ) : (
          ...
          <div className="space-y-2">
            <Label
              htmlFor={`quantity-${localProduct.id}`}
              className="text-sm font-medium"
            >
        ...
        <div className="text-xs text-muted-foreground flex items-center justify-between">
          <span>
            Atualizado em {localProduct.lastUpdated.toLocaleDateString("pt-BR")}
          </span>
