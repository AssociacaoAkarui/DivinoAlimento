...
import { ProductGroup } from "@/utils/product-grouping";
...
export function ProductGroupItem({
  ...
  const [certificacaoFilter, setCertificacaoFilter] = useState<Set<string>>(
    new Set(),
  );
  const [agriculturaFilter, setAgriculturaFilter] = useState<Set<string>>(
    new Set(),
  );
        ...
        <div className="bg-muted/30 p-4 flex items-center justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge variant="secondary" className="text-xs">
                  ...
                  {group.totalVariantes === 1 ? "variante" : "variantes"}
                </Badge>
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            <Button
              ...
              disabled={
                selectedVariantIds.size === 0 && totalActiveFilters === 0
              }
              className="h-9 text-xs"
            >
              Limpar
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="col-span-3">
                        <Label
                          htmlFor={variante.id}
                          className="cursor-pointer truncate block text-sm"
                        >
                          {variante.fornecedor}
                        </Label>
                      </div>
