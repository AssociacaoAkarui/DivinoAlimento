            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <ChevronDown className="user-caret w-3 h-3" style={{ color: '#6B7280' }} />
                </button>
              </DropdownMenuTrigger>
              
              <DropdownMenuContent 
                align="center" 
                className="user-menu w-56 bg-background border shadow-lg z-[60] animate-in fade-in slide-in-from-top-2 duration-200"
