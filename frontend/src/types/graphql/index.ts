...
export type LogoutMutation = {
  __typename?: "Mutation";
  sessionLogout: { __typename?: "LogoutResponse"; success: boolean };
};

export type SystemInformationQueryVariables = Exact<{ [key: string]: never }>;

export type SystemInformationQuery = {
  __typename?: "Query";
  systemInformation: { __typename?: "SystemInformation"; version: string };
};

export type ListarUsuariosQueryVariables = Exact<{ [key: string]: never }>;

export type ListarUsuariosQuery = {
  __typename?: "Query";
...
export type CriarUsuarioMutation = {
  __typename?: "Mutation";
  criarUsuario: {
    __typename?: "Usuario";
    id: string;
...
export type AtualizarUsuarioMutation = {
  __typename?: "Mutation";
  atualizarUsuario: {
    __typename?: "Usuario";
    id: string;
...
export type HealthcheckQuery = {
  __typename?: "Query";
  healthcheck: { __typename?: "HealthCheck"; status: string };
};
...
export type BuscarUsuarioQuery = {
  __typename?: "Query";
  buscarUsuario: {
    __typename?: "Usuario";
    id: string;
...
export function getSdk(
  ...
  return {
    ...
    SystemInformation(
      ...
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<SystemInformationQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SystemInformationQuery>({
            document: SystemInformationDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    ListarUsuarios(
      variables?: ListarUsuariosQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<ListarUsuariosQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ListarUsuariosQuery>({
            document: ListarUsuariosDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    CriarUsuario(
      variables: CriarUsuarioMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<CriarUsuarioMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CriarUsuarioMutation>({
            document: CriarUsuarioDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    AtualizarUsuario(
      variables: AtualizarUsuarioMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<AtualizarUsuarioMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AtualizarUsuarioMutation>({
            document: AtualizarUsuarioDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
    ...
    BuscarUsuario(
      variables: BuscarUsuarioQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"],
    ): Promise<BuscarUsuarioQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<BuscarUsuarioQuery>({
            document: BuscarUsuarioDocument,
            variables,
            requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders },
            signal,
          }),
