...
|-----------|------------------------------------------|
| **Ator Principal** | Administrador, Administrador de Mercado, Fornecedor, Consumidor, Usuário não logado |
| **Pré-condições** |  |
| **Fluxo Normal** | 1. Usuário entra na url do sistema, via browser <br>2. Usuário visualiza informações públicas (cabeçalho, mini texto de apresentação) <br>3. Usuário visualiza link de LOGIN (UC001 e UC002)  |
| **Fluxos Alternativos** | **FA1 - Usuário FORNECEDOR está logado** <br>2a. Usuário visualiza ciclos ativos e link para ofertar produtos, se dentro dos períodos de oferta (UC011); e link para visualizar relatório de fornecedores com a relação de produtos e quantidades que deve entregar (incluir data/horário de entrega e local de entrega) (UC017)<br>2b. Usuário visualiza registros de seus pagamentos e quais estão em aberto ou quitados<br> 2c. Usuário visualiza link para Editar seus dados (UC003)<br><br>**FA2 - Usuário CONSUMIDOR está logado** <br>2a. Usuário visualiza ciclos ativos e composição dos mercados tipo cesta (se houver e já tiverem sido publicados); links para comprar produtos por venda direta, se dentro dos períodos para estas compras (UC016); e link para visualizar relatório de consumidores com a relação de produtos e quantidades que irá receber (incluir data/horário de recebimento e local de recebimento) (UC018)<br>2b. Usuário visualiza registros de seus pagamentos e quais estão em aberto ou quitados<br> 2c. Usuário visualiza link para Editar seus dados (UC003) <br><br>**FA3 - Usuário ADMINISTRADOR DE MERCADO está logado** <br>2a. Usuário visualiza ciclos ativos e link para gerir ciclos; link para visualizar relatório de fornecedores e consumidores por ciclos (UC019 e UC020)<br>2b. Link para tela de registros de pagamento<br>2c. Usuário visualiza registros de seus pagamentos e quais estão em aberto ou quitados<br> 2d. Usuário visualiza link para Editar seus dados (UC003) <br><br>**FA4 - Usuário ADMINISTRADOR está logado** <br>2a. Usuário visualiza ciclos ativos e link para gerir ciclos; link para visualizar relatório de fornecedores e consumidores por ciclos (UC019 e UC020)<br>2b. Link para tela de cadastros <br>2c. Link para tela de registros de pagamento<br>2d. Usuário visualiza registros de seus pagamentos e quais estão em aberto ou quitados<br> 2e. Usuário visualiza link para Editar seus dados (UC003)|
| **Pós-condições** |  |