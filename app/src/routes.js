...
routes.get('/pedidosfornecedorestodosold/:id', ComposicaoController.showTodosPedidosFornecedoresOld)
routes.get('/pedidosfornecedorestodos/:id', ComposicaoController.showTodosPedidosFornecedores)
routes.get('/pedidosfornecedoressobra/:id', ComposicaoController.showComposicaoSobraOferta)
routes.get('/pedidosfornecedoresciclos', RelatorioController.showTodosCiclos)
routes.post('/pedidosfornecedoresciclos', RelatorioController.showPedidosFornecedoresCiclos)
routes.get('/pedidosconsumidoresciclos', RelatorioController.showTodosCiclosConsumidores)
routes.post('/pedidosconsumidoresciclos', RelatorioController.showPedidosConsumidoresCiclos)
routes.get('/pedidosfornecedores/:id', ComposicaoController.showPedidosFornecedores)
...
routes.get('/pedidoconsumidoresconfirmacao/:id', PedidoConsumidoresController.showConfirmacao)
routes.post('/pedidoconsumidores', PedidoConsumidoresController.save)
routes.post('/pedidoconsumidoresconfirmacao', PedidoConsumidoresController.finalizar)

routes.get('/pedidosconsumidorestodos/:id', PedidoConsumidoresController.showTodosPedidosConsumidores)


routes.get('/entregaCicloPDF/:id', RelatoriosController.downloadEntregaCicloPDF)
