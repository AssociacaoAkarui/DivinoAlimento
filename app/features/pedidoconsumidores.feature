...
Funcionalidade: Gestão de Pedidos de Consumidores
  ...
  Cenário: Criar um novo pedido de consumidor com sucesso
    Dado que existe um ciclo ativo para pedidos
  ...
  Cenário: Adicionar produto a um pedido
    ...
    E defino a quantidade do produto no pedido como 5
  ...
  Cenário: Atualizar a quantidade de um produto no pedido
    ...
    Quando eu edito a quantidade do produto no pedido para 6
    E salvo as alterações da quantidade do produto
  ...
  Cenário: Atualizar status do pedido
    ...
    E salvo as alterações do status do pedido
