...
Funcionalidade: Geração de Relatórios
  ...
  @relatorio
  Cenário: REL-01 Gerar relatório de pedidos por consumidor
  ...
  @relatorio
  Cenário: REL-02 Gerar relatório de pedidos por produto
    Dado que existem múltiplos pedidos de consumidores e múltiplos ciclos
    Quando eu seleciono os ciclos desejados
  ...
  @relatorio
  Cenário: REL-03 Gerar relatório de fornecedores
  ...
  @relatorio
  Cenário: REL-04 Exportar relatório em CSV
